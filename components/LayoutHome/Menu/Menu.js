...
const Menu = () => {
	const data = [
		{
			imageName: "sate-sapi-asem",
			imageAlt: "Sate Sapi Asem",
			title: "Sate Sapi Asem",
			kalori: "350",
			lemak: "25,4g",
			protein: "18,5g",
			karbohidrat: "0,5g",
		...
		{
			imageName: "ayam-mentega",
			imageAlt: "Ayam Mentega",
			title: "Ayam Mentega",
			kalori: "250",
			lemak: "10,4g",
			protein: "55,4g",
		...
		{
			imageName: "ikan-kuah-asam",
			imageAlt: "Ikan Kuah Asam",
	...
	return (
		<div className="container mx-auto px-4 xl:px-[120px] mt-10">
