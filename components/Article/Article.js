...
const Article = () => {
	...
	return (
		<div className="container mx-auto px-4 lg:px-[120px] my-[160px]">
			...
			>
				<SwiperSlide className="rounded-3xl bg-light-blue">
					...
					<div className="pt-2 pb-4 px-5 min-h-[200px] flex flex-col justify-between">
						...
						<a className="underline" href="#none">
							Baca Artikel
						</a>
					</div>
				</SwiperSlide>
