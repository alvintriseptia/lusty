...
const Adventage = () => {
	...
	return (
		<section className="container mx-auto px-4 xl:px-[120px] mt-10 ">
			<div className="grid grid-cols-12 lg:gap-10">
				<div className="col-span-12 lg:col-span-4 2xl:col-span-5">
					<div className="relative w-full h-full border-[20px] border-light  bg-gradient-to-br from-light-blue to-dark-blue rounded-card overflow-hidden">
						<Image
							layout="fill"
